...
{
	// 약하고 빠르며 플레이어를 쫒는다.
	public class Enemy_17_BigBlackBox : EnemyType
	{
		private const int Level = 17;

		public Enemy_17_BigBlackBox(GameManager gameManager, int x, int y)
				  ...
				  )
		{
			...
			// Body
			this.BodyColors[0] = Color.FromArgb(75, 75, 75);
			// Arms 1
			this.BodyColors[1] = Color.FromArgb(46, 46, 46);
			// Arms 2
			this.BodyColors[2] = Color.FromArgb(46, 46, 46);
			// Head
			this.BodyColors[3] = Color.FromArgb(17, 17, 17);
			// If Enemy takes damage
			this.BodyColors[4] = Color.FromArgb(241, 241, 241);
