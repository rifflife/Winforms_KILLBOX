...
{
	// 약하고 빠르며 플레이어를 쫒는다.
	public class Enemy_2_SmallOrangeBox : EnemyType
	{
		private const int Level = 2;

		public Enemy_2_SmallOrangeBox(GameManager gameManager, int x, int y)
				  ...
				  )
		{
			...
			// Body
			this.BodyColors[0] = Color.FromArgb(255, 186, 0);
			// Arms 1
			this.BodyColors[1] = Color.FromArgb(200, 146, 0);
			// Arms 2
			this.BodyColors[2] = Color.FromArgb(200, 146, 0);
			// Head
			this.BodyColors[3] = Color.FromArgb(170, 125, 0);
			// If Enemy takes damage
			this.BodyColors[4] = Color.FromArgb(255, 242, 207);
