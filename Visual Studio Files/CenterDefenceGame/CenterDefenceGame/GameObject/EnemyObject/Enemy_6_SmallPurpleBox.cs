...
{
	// 약하고 빠르며 플레이어를 쫒는다.
	public class Enemy_6_SmallPurpleBox : EnemyType
	{
		private const int Level = 6;

		public Enemy_6_SmallPurpleBox(GameManager gameManager, int x, int y)
				  ...
				  )
		{
			...
			// Body
			this.BodyColors[0] = Color.FromArgb(222, 0, 255);
			// Arms 1
			this.BodyColors[1] = Color.FromArgb(175, 0, 201);
			// Arms 2
			this.BodyColors[2] = Color.FromArgb(175, 0, 201);
			// Head
			this.BodyColors[3] = Color.FromArgb(143, 0, 164);
			// If Enemy takes damage
			this.BodyColors[4] = Color.FromArgb(247, 190, 255);
