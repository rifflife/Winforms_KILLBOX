...
{
	// 약하고 빠르며 플레이어를 쫒는다.
	public class Enemy_14_BigRedBox : EnemyType
	{
		private const int Level = 14;

		public Enemy_14_BigRedBox(GameManager gameManager, int x, int y)
				  ...
				  )
		{
			...
			// Arms 2
			this.BodyColors[2] = Color.FromArgb(240, 50, 50);
			// Head
			this.BodyColors[3] = Color.FromArgb(240, 30, 30);
			// If Enemy takes damage
			this.BodyColors[4] = Color.FromArgb(255, 200, 200);
