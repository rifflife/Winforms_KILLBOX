...
{
	// 약하고 빠르며 플레이어를 쫒는다.
	public class Enemy_4_SmallBlueBox : EnemyType
	{
		private const int Level = 4;

		public Enemy_4_SmallBlueBox(GameManager gameManager, int x, int y)
				  ...
				  )
		{
			...
			// Body
			this.BodyColors[0] = Color.FromArgb(112, 140, 200);
			// Arms 1
			this.BodyColors[1] = Color.FromArgb(56, 91, 169);
			// Arms 2
			this.BodyColors[2] = Color.FromArgb(56, 91, 169);
			// Head
			this.BodyColors[3] = Color.FromArgb(21, 50, 117);
			// If Enemy takes damage
			this.BodyColors[4] = Color.FromArgb(200, 200, 255);
